...
namespace Ecommerce.DataAccess.Migrations
{
    ...
    [Migration("20250901171315_ShippingOptions")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Ecommerce.Entities.Models.Auth.Users.Buyer", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Ecommerce.Entities.Models.Reviews.ReviewAttribute", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("ReviewAttributes");
                });

            modelBuilder.Entity("Ecommerce.Entities.Models.Reviews.ReviewHelpfulVote", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Ecommerce.Entities.Models.Reviews.ReviewPhoto", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Ecommerce.Utilities.Enums.Order", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Ecommerce.Entities.Models.Auth.Users.Buyer", b =>
                {
                    b.HasOne("Ecommerce.Entities.Models.Auth.Identity.User", "User")
                        .WithOne()
                        .HasForeignKey("Ecommerce.Entities.Models.Auth.Users.Buyer", "Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Ecommerce.Entities.Models.Cart", b =>
                {
                    b.HasOne("Ecommerce.Entities.Models.Auth.Users.Buyer", "Buyer")
                        .WithOne("Cart")
            ...
            modelBuilder.Entity("Ecommerce.Entities.Models.OrderItem", b =>
                {
                    b.HasOne("Ecommerce.Utilities.Enums.Order", "Order")
                        .WithMany("OrderItems")
            ...
            modelBuilder.Entity("Ecommerce.Entities.Models.Reviews.ReviewAttribute", b =>
                {
                    b.HasOne("Ecommerce.Entities.Models.Reviews.Review", "Review")
                        .WithMany("Attributes")
